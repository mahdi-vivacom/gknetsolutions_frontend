    ...
    <div className="relative min-h-screen flex items-center justify-center bg-slate-950 overflow-hidden font-sans">
      ...
      <div className="relative z-10 w-full max-w-md px-4 py-8">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-slate-400 mt-1">Create your Client Account</p>
        </div>

        {/* Register Card */}
        <Card className="border-slate-800 bg-slate-900/60 backdrop-blur-xl shadow-2xl shadow-black/50">
          <CardHeader>
            <CardTitle className="text-xl text-white">Register Portal Account</CardTitle>
            <CardDescription className="text-slate-400">
              Provide details below to construct your dashboard access profile
            </CardDescription>
          </CardHeader>
          <form onSubmit={handleRegister}>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="bg-slate-950/50 border-slate-800 text-white placeholder-slate-600 focus-visible:ring-orange-500"
                    required
                  />
                </div>
                <div className="space-y-2">
            ...
            <CardFooter className="flex flex-col space-y-4 pt-2">
              ...
              <div className="text-sm text-center text-slate-400">
                ...
                <Link to="/login" className="text-orange-400 hover:text-orange-300 font-semibold underline underline-offset-4">
                  Sign In
                </Link>
              </div>
            </CardFooter>
